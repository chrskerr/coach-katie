...
//
// Adultletics / Views / Home / Elements
//
			...
			<div id="main" className="container">
				...
				<div className="row 200%">
					...
					<div className="6u$ 12u$(medium)">
						...
						<h4>Fit</h4>
						<span className="image fit"><img src="https://source.unsplash.com/pizgoJNQ-xY/800x400" alt="" /></span>
						<div className="box alt">
							<div className="row 50% uniform">
								<div className="4u"><span className="image fit"><img src="https://source.unsplash.com/pizgoJNQ-xY/800x400" alt="" /></span></div>
								<div className="4u"><span className="image fit"><img src="https://source.unsplash.com/GYr9A2CPMhY/800x400" alt="" /></span></div>
								<div className="4u$"><span className="image fit"><img src="https://source.unsplash.com/RL1AS-Kryzw/800x400" alt="" /></span></div>
								<div className="4u"><span className="image fit"><img src="https://source.unsplash.com/c59hEeerAaI/800x400" alt="" /></span></div>
								<div className="4u"><span className="image fit"><img src="https://source.unsplash.com/pizgoJNQ-xY/800x400" alt="" /></span></div>
								<div className="4u$"><span className="image fit"><img src="https://source.unsplash.com/pizgoJNQ-xY/800x400" alt="" /></span></div>
								<div className="4u"><span className="image fit"><img src="https://source.unsplash.com/pizgoJNQ-xY/800x400" alt="" /></span></div>
								<div className="4u"><span className="image fit"><img src="https://source.unsplash.com/pizgoJNQ-xY/800x400" alt="" /></span></div>
