...
$.fn.panel = function( userConfig ) {
	...
	$this._hide = function( event ) {
		...
		window.setTimeout( function() {
			if ( config.resetForms ) $this.find( "form" ).each(() => this.reset());
		}, config.delay );
	};
	...
	$this.on( "click touchend touchstart touchmove", event => event.stopPropagation());
	...
	$body.on( "click touchend", event => $this._hide( event ));
